        ...
        <div id="page-content">                
           ...
           <!--  <div id="page-title">
            ...
            <!-- Conten form --> 
                        ...
                        <form class="form-horizontal bordered-row" id="formm" name="formm" data-parsley-validate="" method="POST" action="<?=base_url();?>entryp/Entryp5/DTDaddData" enctype="multipart/form-data" >
                            <div class="panel-body">
                                <div class="example-box-wrapper">
                                    <div class="row">
                                        <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                               <select  ng-options="promo.promotion_id as promo.promotion_desc for promo in promotions" ng-model="PROMO" style="width:200px;"></select>                               
                            </div>
                        </div>
...
/*url:'<?=base_url();?>entryp/Entryp5/'+url,*/
</script>
<script>
/*function coba(){
 $.ajax({
  type: "post",
  url: "<?=base_url();?>entryp/Entryp5/DTDaddData",
  cache: false,    
...
<script>
	...
	function getDataHW(){ //GET DATA HW
		...
		$.ajax({
			 type     : 'POST',
			url      :'<?=base_url();?>entryp/Entryp5/getDataHW',
			 data     : jparams,
			 dataType : 'json',
...
app.controller('myCtrl', function($scope,$http,fileUpload) {
   ...
   $scope.ESTIMATED_INSTALLATION = 200000;
    ...
    { 
        console.log('123');
        //return parseInt($scope.ESTIMATED_COST_PACKAGE) + parseInt($scope.ESTIMATED_ALACARTE)
    }*/

    $scope.getmasterpromotion = function()
    {
        $http.get("<?php echo site_url('entryp/Entryp5/angular_getPromoData');?>", {params:{"param1": promoId }}).success(function (result_DataPromo) { 
...
*/  
    ...
    $scope.searchProspectNumber = function()
    {
        ...
        $http.get("<?php echo site_url('entryp/Entryp5/angular_getProspectDatabyProspectNumber');?>", {params:{"param1": $scope.pnumb }}).success(function (result_DataProspectData) { 
    ...
    $scope.getProsedurProspectNbr = function ()
    {
        ...
        $http.get("<?php echo site_url('entryp/Entryp5/angular_getGenerateProspectNumber');?>", {params:{"param1": sales_code_temp}}).success(function (result_ProspectNbrGenerator) { 
    ...
    $scope.getValuePackageBasic = function()
    {
        ...
        $http.get("<?php echo site_url('entryp/Entryp5/angular_getPackageBasicData');?>", {params:{"param1": bundele_id}}).success(function (result_DataPackageBasic) { 
    ...
    {   
        ...
        $http.get("<?php echo site_url('entryp/Entryp5/angular_getPackageAlacarteData');?>", {params:{"param1": bundele_id,"param2[]":$scope.PACKAGE_ALACARTE}}).success(function (result_DataPackageAlacarte) { 
    ...
    function getCostTransport(zipcodevalues)
    {
        ...
        $http.get("<?php echo site_url('entryp/Entryp5/angular_getCostTransportData');?>", {params:{"param1": values}}).success(function (result_DataCostTransport) { 
    ...
    $scope.getOperationalEntityView = function()
    {
        ...
        $http.get("<?php echo site_url('entryp/Entryp5/angular_OperationalEntityView');?>").success(function(result){
    ...
    $scope.getSalesProfileData = function()
    {
        ...
        $http.get("<?php echo site_url('entryp/Entryp5/angular_EmployeeView');?>", {params:{"param1": sale_code, "param2": sales_name}}).success(function (result_DataSalesProfile) { 
    ...
    $scope.getZipCodeViewData = function()
    {
    	...
    	$http.get("<?php echo site_url('entryp/Entryp5/angular_getZipCodeViewData');?>", {params:{"param1": val1, "param2": val2}}).success(function (result_DataZipcode) { 
    ...
    $scope.saveFile  = function(filename)
    {
        ...
        var fileUrl = '<?php echo site_url('entryp/Entryp5/angular_UploadData');?>';
    ...
    {   
        ...
        $http.get("<?php echo site_url('entryp/Entryp5/angular_ViewUploadData');?>", {params:{"param1": $scope.pnumb}}).success(function (resultDataUpload) { 
    		//console.log(result_DataZipcode);
    ...
    //not a function to call resultDataUpload (bukan sebuah fungsi) tapi langsung memanggil data upload secara langsung
        /*$http.get("<?php echo site_url('entryp/Entryp5/angular_ViewUploadData');?>").success(function(resultDataUpload){
