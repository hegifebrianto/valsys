...
<tr>
    ...
    <td><a class="tl-label bs-label label-info" href="<?=base_url();?>entryp/Entryp/updateEP_DTD/<?= $row->PROSPECT_ID?>">Detail</a></td>
    <?php
    }else if($aksi=="BTP"){
    ?>
    ...
    <?php
        ...
        ?>
        <td><a class="tl-label bs-label label-info" href="<?=base_url();?>entryp/Entryp/app_tl_detail/<?= $row->PROSPECT_ID?>">Detail</a></td>
    <?php
    }
    ?>
