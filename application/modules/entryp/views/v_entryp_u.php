...
<?=$side_menu?>
            ...
            <div class="panel-body">
                ...
                <div class="example-box-wrapper">
                    <ul class="list-group row">
                        ...
                        <li class="col-md-3" ng-hide="salesc=='dtd' || salesc=='ms' || salesc=='scc' || salesc=='sgs'" ng-show="salesc=='dtdbb' || salesc=='dealer'  || salesc=='df'"  >
                    ...
                    <div class="form-group" ng-hide="status" ng-show="infodata" >
                     ...
                     <div class="form-group" ng-hide="reason" ng-show="statuss" >
                            ...
                            <div class="col-sm-6">
                             ...
                             <select class="col-sm-12 "  ng-model="REASONn" id="category" name="A4"  class="" ng-hide="aa" ng-show="statuss=='Approve'">
                                     <?php 
                          ...
                          <select class="col-sm-12" ng-model="rej" id="optionrej4" name="R4" class="required" ng-hide="rr" ng-show="statuss=='Reject'">
                                    <!--  <option value="" selected="selected">Select</option> -->
                                    
                                     <?php 
                                    foreach ($admin_reject as $ar) {
                                    echo "<option value='$ar[NOTE]'>$ar[NOTE]</option>";
                                    }
                                    ?>
                                      </select>
                            <select class="col-sm-12" ng-model="pend" id="optionrej4" name="R4" class="required" ng-hide="rr" ng-show="statuss=='Pending'">
                                    <!--  <option value="" selected="selected">Select</option> -->
                                    
                                     <?php 
                                    foreach ($admin_pending as $ap) {
                                    echo "<option value='$ap[NOTE]'>$ap[NOTE]</option>";
                                    }
                                    ?>
                                      </select>
  ...
  <td>
      ...
      <div class="panel" ng-hide="profilecustomer" ng-show="checked">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                 <input type="text" id="pt" name="pt" ng-model="PLN" class="form-control" disabled="">
             </div>
         </div>
         <div class="form-group">
            <label class="col-sm-3 control-label"><label class="font-red">*</label>Main Phone</label>
            <div class="col-sm-6">
                <input type="text" id="pt" name="pt" ng-model="wphone" class="form-control" disabled="">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label"><label class="font-red">*</label>Mobile Phone</label>
            <div class="col-sm-6">
              <input type="text" id="pt" name="pt" ng-model="MOBILE_PHONE" class="form-control" disabled="">
          </div>
      </div>
        <div class="form-group">
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label">SGS Parent Number</label>
        <div class="col-sm-6">
            <input type="text" id="pt" name="pt" ng-model="SGS_NUMBER" class="form-control" disabled="">
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-3 control-label">SGS Parent Name</label>
        <div class="col-sm-6">
            <input type="text" id="pt" name="pt" ng-model="SGS_NAME" class="form-control" disabled="">
        </div>
    </div>
    <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <h3 class="title-hero">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                        <input disabled="" type="text" name="PROVINCE" ng-model="PROVINCE" placeholder="Province" required class="form-control"></input>    
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">City</label>
                                                        <div class="col-sm-6">
                                                            <input disabled="" type="text" name="CITY" ng-model="CITY" placeholder="City" required class="form-control"></input>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                        <input disabled="" type="text" name="DISTRICT" ng-model="DISTRICT" placeholder="District" required class="form-control"></input>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                        <input disabled="" type="text" name="SUBDISTRICT" ng-model="SUBDISTRICT" placeholder="Sub District" required class="form-control"></input>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input disabled="" type="text" ng-model="ZIPCODE" name="ZIPCODE" placeholder="Zipcode" required class="form-control" >
                                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <h3 class="title-hero">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <textarea disabled="" type="text" name="INSTALLATION_ADDRESS" ng-model="INSTALL_ADDRESS" id="installaddress" placeholder="Installation Address" required class="form-control"></textarea>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <textarea disabled="" type="text" name="DIRECTIONS" ng-model="INSTALL_LANDMARK" id="landmark" placeholder="LANDMARK" required class="form-control"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <br><br>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Province</label>
                                                        <div class="col-sm-6">
                                                        <input type="text" disabled="" name="PROVINCE_INSTALLATION" ng-model="PROVINCE_INSTALL" placeholder="Province"  required class="form-control" ng-disabled="cek_install" ></input>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">City</label>
                                                        <div class="col-sm-6">
                                                            <input disabled="" type="text" name="CITY_INSTALLATION" ng-model="CITY_INSTALL" placeholder="City"  required class="form-control" ng-disabled="cek_install"></input>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Kecamatan</label>
                                                        <div class="col-sm-6">
                                                        <input  disabled="" type="text" name="DISTRICT_INSTALLATION" ng-model="DISTRICT_INSTALL" placeholder="District"  required class="form-control" ng-disabled="cek_install"></input>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Kelurahan</label>
                                                        <div class="col-sm-6">
                                                        <input disabled="" type="text" name="SUBDISTRICT_INSTALLATION" ng-model="SUBDISTRICT_INSTALL" placeholder="Sub District"  required class="form-control" ng-disabled="cek_install"></input>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label"><label class="font-red">*</label>Zipcode</label>
                                                        <div class="col-sm-4">
                                                            <input disabled="" type="text" ng-model="ZIPCODE_INSTALL" name="ZIPCODE_INSTALLATION" placeholder="Zipcode" required class="form-control" ng-disabled="cek_install">
                                            ...
                                            <div class="row">
                                                ...
                                                <h3 class="title-hero">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label"><label class="font-red">*</label>Installation Address</label>
                                                        <div class="col-sm-6">
                                                            <textarea type="text" disabled="" name="INSTALLATION_ADDRESSbilling" ng-model="INSTALL_ADDRESSbilling" id="installaddressbilling" placeholder="Installation Address" required class="form-control"></textarea>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label"><label class="font-red">*</label>Direction/Landmark</label>
                                                        <div class="col-sm-6">
                                                            <textarea disabled="" type="text" name="DIRECTIONSbilling" ng-model="INSTALL_LANDMARKbilling" id="landmarkbilling" placeholder="LANDMARK" required class="form-control"></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group"></div>
                                                        ...
                                                        <label class="col-sm-3 control-label">Province</label>
                                                        <div class="col-sm-6">
                                                        <input type="text" disabled="" name="PROVINCE_BILLING" ng-model="PROVINCE_BILLING" placeholder="Province"  required class="form-control" ng-disabled="cek_billing_identity||cek_billing_install"></input>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">City</label>
                                                        <div class="col-sm-6">
                                                            <input type="text" disabled="" name="CITY_BILLING" ng-model="CITY_BILLING" placeholder="City"  required class="form-control" ng-disabled="cek_billing_identity||cek_billing_install"></input>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Kecamatan</label>
                                                        <div class="col-sm-6">
                                                        <input type="text" disabled="" name="DISTRICT_BILLING" ng-model="DISTRICT_BILLING" placeholder="District"  required class="form-control" ng-disabled="cek_billing_identity||cek_billing_install"></input>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Kelurahan</label>
                                                        <div class="col-sm-6">
                                                        <input type="text" disabled="" name="SUBDISTRICT_BILLING" ng-model="SUBDISTRICT_BILLING" placeholder="Sub District"  required class="form-control" ng-disabled="cek_billing_identity||cek_billing_install"></input>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label"><label class="font-red">*</label>Zipcode</label>
                                                        <div class="col-sm-4">
                                                            <input type="text" disabled="" ng-model="ZIPCODE_BILLING" name="ZIPCODE_BILLING" placeholder="Zipcode" required class="form-control" ng-disabled="cek_billing_identity||cek_billing_install">
            ...
            <h3 class="title-hero">
                ...
                Emergency (different house)
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="sibling" disabled="" id="sibling" name="emergency_sibling" ng-model="EMERGENCY_SIBLING" class="custom-select required">
             ...
             <div class="col-md-6">    
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input disabled="" type="text" id="emergency_phone" name="emergency_phone" ng-model="EMERGENCY_PHONE" data-parsley-type="digits" placeholder="Digits only" required class="form-control">
                            </div>
                        </div>
                       ...
                       <div class="form-group">
                            <label class="col-sm-3 control-label"><label class="font-red">*</label>Address</label>
                            <div class="col-sm-6">
                                <input  disabled=""type="text" id="emergency_address" name="emergency_address" ng-model="EMERGENCY_ADDRESS" placeholder="Required Field" required class="form-control">
                            </div>
                        </div>
                        </div>
        </div>
    ...
    <div class="panel" ng-hide="Sales" ng-show="checkedSales">
                ...
                <div class="row">
                   ...
                   <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input disabled="" type="text" id="sales_nik" name="sales_nik" ng-model="SALES_NIK" placeholder="NIK" required class="form-control" disabled="">
      ...
      <div class="form-group">
        <label class="col-sm-3 control-label"><label class="font-red">*</label>Name</label>
        <div class="col-sm-6">
            <input type="text" disabled="" id="sales_name" name="sales_name" ng-model="SALES_NAME" placeholder="Sales Profile " required class="form-control">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input id="sales_differentcauses" disabled="" name="sales_differentcauses" ng-model="SALES_DIFFERENTCAUSES" type="text" placeholder="Different Installation Causes" required class="form-control" disabled="">
        </div>
    </div>
    </div>
    <div class="col-md-6">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input id="sales_code" disabled="" name="sales_code" ng-model="SALES_CODE"  type="text" placeholder="Required Field" required class="form-control" disabled="">
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-3 control-label"><label class="font-red">*</label>Office Branch</label>
        <div class="col-sm-6">
            <input id="sales_officebranch" disabled="" name="sales_officebranch" ng-model="SALES_OFFICEBRANCH" type="text" placeholder="Required Field" required class="form-control" disabled="">
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-3 control-label"><label class="font-red">*</label>Name of Head Branch</label>
        <div class="col-sm-6">
            <input type="text" disabled="" id="sales_namebranchhead" name="sales_namebranchhead" ng-model="SALES_NAMEBRACHHEAD" placeholder="Required Field" required class="form-control" disabled="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" disabled="" name="ENTITYCODE"  placeholder="Entity Code"  class="form-control" ng-model="ENTITY_CODE"  disabled="">
        </div>

        <label class="col-sm-3 control-label"></label>
        <div class="col-sm-5">
            <input type="text" disabled="" name="POS"  placeholder="Point Of Sales"  class="form-control" ng-model="POINT_OF_SALES" >
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    Estimated Costs
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" ng-model="INSTALLATION_COST" readonly="" disabled="">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" value="" ng-model="TOTAL_COST"  disabled="">
                            </div>
                        </div> 
                        <!-- <div class="form-group">
                            <label class="col-sm-3 control-label">Total Estimated Costs</label>
...
//fileupload
    ...
    $scope.PLN='<?php echo $detail->PLN_ID;?>';
    $scope.wphone='<?php echo $detail->WORK_PHONE;?>';
    $scope.MOBILE_PHONE='<?php echo $detail->MOBILE_PHONE;?>';
    $scope.HOME_PHONE='<?php echo $detail->HOME_PHONE;?>';
    $scope.EMAIL='<?php echo $detail->EMAIL;?>';
    $scope.OCCUPATION='<?php echo $detail->OCCUPATION;?>';
    $scope.INCOME='<?php echo $detail->INCOME;?>';
    $scope.SGS_NUMBER='<?php echo $detail->SGS_NUMBER;?>';
    $scope.SGS_NAME='<?php echo $detail->SGS_NAME;?>';
    $scope.SGS_NAME='<?php echo $detail->SGS_NAME;?>';
