...
$config['DX_users_table'] = 'APP_USER';
$config['DX_user_profile_table'] = 'APP_USER_DETAIL';
$config['DX_user_temp_table'] = 'APP_USER_TEMP';
$config['DX_user_autologin'] = 'APP_USER_AUTOLOGIN';
$config['DX_roles_table'] = 'APP_ROLES';
$config['DX_permissions_table'] = 'APP_PERMISSIONS';
$config['DX_login_attempts_table'] = 'APP_LOGIN_ATTEMPTS';
$config['DX_app_privilege_module_ext'] = 'APP_PRIVILEGE_MODULE_EXT2';
$config['DX_app_module'] = 'APP_MODULES';
/*
|--------------------------------------------------------------------------
| Password salt
|--------------------------------------------------------------------------
