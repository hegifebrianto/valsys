...
/* 					if ($this->dx_auth->is_max_login_attempts_exceeded())
					...
					$data['auth_message'] = "<div align='center' class='error' >".$errmsg."</div>";
					$data['header'] = $this->load->view('includes/header');
					$data['main_content'] = $this->load->view($this->dx_auth->login_view);
					$data['footer'] = $this->load->view('includes/footer');
